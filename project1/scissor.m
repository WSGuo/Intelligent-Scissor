...
% Last Modified by GUIDE v2.5 25-Feb-2018 20:22:56
...
function input_nodes_num_Callback(hObject, eventdata, handles)
% hObject    handle to input_nodes_num (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of input_nodes_num as text
%        str2double(get(hObject,'String')) returns contents of input_nodes_num as a double
handles.input_nodes_num = str2double(get(hObject,'String'));
guidata(hObject,handles);


% --- Executes during object creation, after setting all properties.
function input_nodes_num_CreateFcn(hObject, eventdata, handles)
% hObject    handle to input_nodes_num (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
