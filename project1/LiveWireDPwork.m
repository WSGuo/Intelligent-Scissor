function nodeArray = LiveWireDPwork(numExp, seedCol,seedRow,curCol, curRow, costGraph)

disp('start calculating LiveWireDP work mode');
%get dimension
...
while ((flagEmpty == false) && (count <= numExp || numExp == -1))
    ...
    disp('finish LiveWireDP work mode');
